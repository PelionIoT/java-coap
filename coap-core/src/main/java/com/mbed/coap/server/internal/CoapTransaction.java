...
public class CoapTransaction {
    ...
    private final CoapServerForUdp coapServer;
    ...
    public CoapTransaction(RequestCallback callback, CoapPacket coapRequest, final CoapServerForUdp coapServer, TransportContext transContext, Consumer<CoapTransactionId> sendErrConsumer) {
        this(callback, coapRequest, coapServer, transContext, Priority.NORMAL, sendErrConsumer);
    }

    public CoapTransaction(RequestCallback callback, CoapPacket coapRequest, final CoapServerForUdp coapServer, TransportContext transContext, Priority transactionPriority, Consumer<CoapTransactionId> sendErrConsumer) {
        if (callback == null) {
