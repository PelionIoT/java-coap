...
public final class CoapRequest {
    ...
    public boolean equals(Object o) {
        ...
        return method == that.method && Objects.equals(token, that.token) && options.equals(that.options) && Objects.equals(payload, that.payload) && peerAddress.equals(that.peerAddress) && transContext.equals(that.transContext);
    }
