...
public class SingleConnectionSSLSocketServerTransport implements CoapTransport {
    private static Logger LOGGER = LoggerFactory.getLogger(SingleConnectionSSLSocketServerTransport.class);

    private Thread serverThread;
    private final SSLServerSocket serverSocket;
    private OutputStream outputStream;

    public SingleConnectionSSLSocketServerTransport(SSLContext sslContext) throws IOException {
