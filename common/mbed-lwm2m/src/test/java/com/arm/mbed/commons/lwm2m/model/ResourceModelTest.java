...
import com.arm.mbed.commons.lwm2m.model.Instances;
import com.arm.mbed.commons.lwm2m.model.ResourceModel;
...
public class ResourceModelTest {
    ...
    private void validateStringLengthUnspecified(ResourceModel stringRes) {
    ...
    private void validateOpaqueResourceAnySize(ResourceModel binRes) {
    ...
    private ResourceModel createResourceModel (Type type, String range) {
